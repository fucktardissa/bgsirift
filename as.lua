...
--- PING CONFIGURATION ---
local PING_ID_DONATOR = "1389789523357077575"
local PING_ID_BOOSTER = "1389793184883671141"
local PING_ID_LEVEL15 = "1389815796896763964"
    ...
    while task.wait(5) do
        if isTeleporting then
            ...
            if riftInstance and not reportedRiftsInServer[RIFT_NAME] then
                ...
                broadcastRiftFoundAndWait(riftInstance)
            end
            ...
            -- Step 4: After all checks, hop to the next server.
            print("All checks complete for this server. Hopping...")
            attemptHop()
        end
    end
end)
